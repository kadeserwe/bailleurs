...
@RestController
@RequestMapping("/api/bailleurs-kafka")
public class BailleursKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BailleursKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BailleursKafkaResource(KafkaProperties kafkaProperties) {
